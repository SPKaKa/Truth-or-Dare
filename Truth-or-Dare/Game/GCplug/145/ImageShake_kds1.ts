...
module CommandExecute {
     ...
     * 自定义指令-图像震动函数
     */
    export function customCommand_15003(commandPage: CommandPage, cmd: Command, trigger: CommandTrigger, triggerPlayer: ClientPlayer, playerInput: any[], cp: CustomCommandParams_15003): void {
        // 获取通道
