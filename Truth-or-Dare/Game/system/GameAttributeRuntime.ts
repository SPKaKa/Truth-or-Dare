class WorldData {
    ...
    static SEmap: DataStructure_MapDataSE[]; // = [];
    static DefaultFootStep: string; // = ""; 默认脚步音效
    static bUseDefaultFootStep: boolean; // = false; 启用默认脚步音效
    ...
    static W26_isTrace: boolean; // = false; 是否打印追踪变量信息
    static W26recordCount: number; // = 10; 记录最大数值
    static w26VarShowKey: number; // = 0; 监控显示按键
    static w26VarShowMiniKey: number; // = 0; 小监控显示按键
}
class PlayerData {
