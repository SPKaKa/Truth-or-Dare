...
var GUI_Reward = (function (_super) {
    ...
    function GUI_Reward() {
        ...
        _this_2.getExpAnimationTask = "getExpAnimationTask";
        _this_2.on(EventObject.DISPLAY, _this_2, _this_2.onDisplay);
        _this_2.dropItemList.on(UIList.ITEM_CREATE, _this_2, _this_2.onCreateDropItemListDisplayItem);
    ...
    GUI_Reward.prototype.taskShowGetItems = function () {
        ...
        new SyncTask(this.getExpAnimationTask, function () {
            SyncTask.taskOver(_this_2.getExpAnimationTask);
        });
    };
        ...
        for (var i = 0; i < Game.player.data.party.length; i++) {
            ...
            for (var lv = actorIncreaseExpRes.fromLv; lv <= actorIncreaseExpRes.toLv; lv++) {
                ...
                new SyncTask(singleActorTask, function (singleActorTask, actorIndex, lv, thisLvStartExp, thisLvEndExp, thisLvNeedExp) {
                    ...
                    var actorUI = _this_2.actorList.getItemUI(actorIndex);
            ...
            new SyncTask(this.getExpAnimationTask, function (i) {
                ...
                if (actorIncreaseExpRes) {
                    ...
                    if (learnSkills.length != 0) {
                        _this_2.skillBlock.visible = true;
                        _this_2.learnSkillActorFace.image = actor.face;
                        _this_2.learnSkillText.text = "" + WorldData.word_learnSkill;
                        var arr = [];
                        ...
                        _this_2.learnSkillList.items = arr;
                        setTimeout(function () {
                            _this_2.skillBlock.visible = false;
                            setTimeout(function () {
                                SyncTask.taskOver(_this_2.getExpAnimationTask);
                            }, 200);
                        }, 1500);
